package calitei.parking.api.auth;
...
import calitei.parking.api.token.Token;
import calitei.parking.api.token.TokenRepository;
import calitei.parking.api.token.TokenType;
import calitei.parking.api.entities.Role;
  ...
  public AuthenticationResponse register(RegisterRequest request) throws UserAlreadyExistsException {
    if(userRepository.existsByEmail(request.getEmail())) {
      throw new UserAlreadyExistsException(ExceptionUtility
              .createErrorMessage("User", request.getEmail(), MethodType.CREATE));
    }
